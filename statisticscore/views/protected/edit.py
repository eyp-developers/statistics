...
from statisticscore.forms.session_edit import SessionEditForm
...
def edit(request, session_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return HttpResponseRedirect(reverse('statisticscore:edit', args=[session_id]))
        ...
        form = SessionEditForm({'name': s.name,
                                ...
                                'statisticscore': s.session_statistics,
    ...
    return check_authorization_and_render(request,
                                          'statisticscore/session_edit.html',
                                          context, s)
