...
def runningorder(request, session_id):
    ...
    if request.method == 'POST':
        ...
        if 'active_debate' in request.POST:
            ...
            if debate_form.is_valid():
                ...
                return HttpResponseRedirect(reverse('statisticscore:runningorder', args=[session_id]))
    ...
    return check_authorization_and_render(request, 'statisticscore/runningorder.html', context, session)
