...
def debate(request, session_id, committee_id):
    ...
    if statistics_type == 'JF':  # Should use or statement
        return render(request, 'statisticscore/joint.html', context)
    elif statistics_type == 'SF':
        return render(request, 'statisticscore/joint.html', context)
    elif statistics_type == 'S':
        return render(request, 'statisticscore/statistics.html', context)
    elif statistics_type == 'C':
        return render(request, 'statisticscore/content.html', context)
